...
Show the next results release date in the closing “what to watch” section, beside the checks it schedules (not in the header), with Confirmed / Estimated / Not announced, period, source and schedule-check date. Keep results, call and filing events separate. Recheck the schedule when returning. A passed date is not proof of publication.
